  ...
  constructor(websocketInstance, options) {
    ...
    return (async () =>
      new Promise((resolve, reject) => {
        const initMessageOperator = (messageText) => {
          ...
          try {
            ...
            if (clientRequest.type === "init") {
              ...
              this.logger.silly(`Server key: ${this.key} received from Server`);
              ...
              if (
                ...
                this.logger.debug(`Sent init message to server with message`, {
                  version: this.options.version,
                  key: this.key,
                });
              } else {
              ...
              if (!this.options.callback) resolve(universalSession);
              else {
        ...
        this.websocketInstance.addEventListener("message", initMessageOperator);
